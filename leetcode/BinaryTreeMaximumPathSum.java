 ...
 */
// get longest path in the tree between two nodes, which can be solved recursively by getting the
// max depth in the left and max depth in the right, and return the max
// between maxDepthLeft + maxDepthRight and previousSolution